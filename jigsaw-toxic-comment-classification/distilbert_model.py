# Assuming base_model.py and distilbert_model.py are in the same directory
...
class DistilBertModel(BaseModel):
    ...
    def train(self, train_df, val_df):
        ...
        self.model = DistilBertForSequenceClassification.from_pretrained('distilbert-base-uncased', num_labels=self.num_labels).to(self.device)
