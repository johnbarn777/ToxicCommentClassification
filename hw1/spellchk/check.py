            ...
            if testfile_key in zip_data:
                with open(testfile_path, 'r') as ref:
                    ...
                    if len(ref_data) == len(output_data):
                        ...
                        tally = spellchk_check.accuracy(ref_data, output_data)
...
if __name__ == '__main__':
    ...
    argparser.add_argument("-t", "--refcases", dest="ref_dir", default=os.path.join('data', 'reference'), help="references directory [default: data/reference]")
